import{E as ne,L as se,U as re,c as p,j as c,m as y,H as U,P as ae,i as v,t as l,d as ie,r as m,B as C,o as le,a as e,l as V,g as b,u as h,p as D,f as w,C as R,A as M,F as oe,e as ue,n as L,s as W,_ as de}from"./index-CW8OwD2x.js";var G="clover",ce=function(a){return a===3?"v3":a},J="https://js.stripe.com",pe="".concat(J,"/").concat(G,"/stripe.js"),ve=/^https:\/\/js\.stripe\.com\/v3\/?(\?.*)?$/,ge=/^https:\/\/js\.stripe\.com\/(v3|[a-z]+)\/stripe\.js(\?.*)?$/;var me=function(a){return ve.test(a)||ge.test(a)},fe=function(){for(var a=document.querySelectorAll('script[src^="'.concat(J,'"]')),r=0;r<a.length;r++){var n=a[r];if(me(n.src))return n}return null},q=function(a){var r="",n=document.createElement("script");n.src="".concat(pe).concat(r);var o=document.head||document.body;if(!o)throw new Error("Expected document.body not to be null. Stripe.js requires a <body> element.");return o.appendChild(n),n},be=function(a,r){!a||!a._registerWrapper||a._registerWrapper({name:"stripe-js",version:"8.6.0",startTime:r})},S=null,j=null,F=null,he=function(a){return function(r){a(new Error("Failed to load Stripe.js",{cause:r}))}},ye=function(a,r){return function(){window.Stripe?a(window.Stripe):r(new Error("Stripe.js not available"))}},xe=function(a){return S!==null?S:(S=new Promise(function(r,n){if(typeof window>"u"||typeof document>"u"){r(null);return}if(window.Stripe){r(window.Stripe);return}try{var o=fe();if(!(o&&a)){if(!o)o=q(a);else if(o&&F!==null&&j!==null){var d;o.removeEventListener("load",F),o.removeEventListener("error",j),(d=o.parentNode)===null||d===void 0||d.removeChild(o),o=q(a)}}F=ye(r,n),j=he(n),o.addEventListener("load",F),o.addEventListener("error",j)}catch(f){n(f);return}}),S.catch(function(r){return S=null,Promise.reject(r)}))},we=function(a,r,n){if(a===null)return null;var o=r[0],d=o.match(/^pk_test/),f=ce(a.version),g=G;d&&f!==g&&console.warn("Stripe.js@".concat(f," was loaded on the page, but @stripe/stripe-js@").concat("8.6.0"," expected Stripe.js@").concat(g,". This may result in unexpected behavior. For more information, see https://docs.stripe.com/sdks/stripejs-versioning"));var k=a.apply(void 0,r);return be(k,n),k},_,X=!1,Y=function(){return _||(_=xe(null).catch(function(a){return _=null,Promise.reject(a)}),_)};Promise.resolve().then(function(){return Y()}).catch(function(i){X||console.warn(i)});var Se=function(){for(var a=arguments.length,r=new Array(a),n=0;n<a;n++)r[n]=arguments[n];X=!0;var o=Date.now();return Y().then(function(d){return we(d,r,o)})},_e=`
    .p-progressbar {
        display: block;
        position: relative;
        overflow: hidden;
