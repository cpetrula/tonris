...
DROP PROCEDURE IF EXISTS create_usage_records_table;

DELIMITER //
CREATE PROCEDURE create_usage_records_table()
BEGIN
    ...
    IF NOT EXISTS (
        ...
        CREATE TABLE usage_records (
            ...
            is_overage TINYINT(1) DEFAULT 0 COMMENT 'Whether this usage is overage (beyond included minutes)',
...
-- Run the procedure
CALL create_usage_records_table();
